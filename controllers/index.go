...
func (this *IndexController) Get() {
	...
	RequestURI, dirs, files, parentPath, _ := browser(this.Ctx.Request.RequestURI)
...
func browser(urlQuery string) (RequestURI string, dirs []fileType, files []fileType, parentPath string, err error) {
